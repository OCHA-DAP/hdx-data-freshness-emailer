...
"""
    ...
    def prepare_user_emails(
        datasethelper, include_datasetdate, datasets, sheet, sheetname
    ):
    ...
    def prepare_admin_emails(
        datasethelper, datasets, startmsg, sheet, sheetname, dutyofficer=None
    ):
        datasets_flat = list()
        msg = [startmsg]
    ...
    def email_admins(
        ...
        msg, htmlmsg = self.prepare_admin_emails(
            datasethelper, datasets, startmsg, sheet, sheetname, dutyofficer
        )
