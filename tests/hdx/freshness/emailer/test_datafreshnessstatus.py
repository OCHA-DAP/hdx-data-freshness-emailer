...
class TestDataFreshnessStatus:
    ...
    def test_freshnessbroken(self, configuration, database_broken, users):
        ...
        assert TestDataFreshnessStatus.email_users_result == \
               [([{'id': 'blah3', 'name': 'blah3name', 'sysadmin': True, 'display_name': 'blah3disp',
                   'email': 'blah3@blah.com', 'fullname': 'blah3full'},
                  {'id': 'blah4', 'name': 'blah4name', 'sysadmin': True, 'display_name': 'blah4disp',
                   'email': 'blah4@blah.com', 'fullname': 'blah4full'}], 'Broken datasets',
        ...
        assert TestDataFreshnessStatus.email_users_result == \
               [([{'email': 'blah@blah.com', 'fullname': 'blahfull', 'display_name': 'blahdisp', 'name': 'blahname',
                   'id': 'blah', 'sysadmin': False},
                  {'email': 'blah5@blah.com', 'name': 'blah5name', 'fullname': 'blah5full', 'id': 'blah5',
