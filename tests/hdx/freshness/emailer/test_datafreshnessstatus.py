...
class TestDataFreshnessStatus:
    ...
    def email_users(users_to_email, subject, text_body, html_body, cc, bcc):
        TestDataFreshnessStatus.email_users_result.append((users_to_email, subject, text_body, html_body, cc, bcc))
                ...
                def get_values():
                    return [['URL', 'Title', 'Organisation', 'Maintainer', 'Maintainer Email', 'Org Admins',
                            ...
                            ['http://lala/dataset/yemen-admin-boundaries', 'Yemen - Administrative Boundaries',
                             ...
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                ...
                def get_values():
                    return [['URL', 'Title', 'Organisation', 'Maintainer', 'Maintainer Email', 'Org Admins',
                            ...
                            ['http://lala/dataset/yemen-admin-boundaries-live',
                             ...
                             'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Live',
                             '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                             '2017-01-02T19:07:30.333492', 3, 'Andrew', 'Contacted Maintainer'],
                            ['http://lala/dataset/yemen-admin-boundaries-day', 'Yemen - Administrative Boundaries Day',
                             'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every day',
                             '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                             '2017-01-02T19:07:30.333492', 3, 'Andrew', 'Contacted Maintainer'],
                            ['http://lala/dataset/yemen-admin-boundaries-week',
                             'Yemen - Administrative Boundaries Week',
                             'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every week',
                             '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                             '2017-01-02T19:07:30.333492', 3, 'Andrew', 'Contacted Maintainer'],
                            ['http://lala/dataset/yemen-admin-boundaries-month',
                             'Yemen - Administrative Boundaries Month',
                             'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com',
                             'Every month',
                             '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                             '2017-01-02T19:07:30.333492', 3, 'Andrew', 'Contacted Maintainer'],
                            ['http://lala/dataset/yemen-admin-boundaries-as-needed',
                             ...
                             'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'As needed',
                             '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                             '2017-01-02T19:07:30.333492', 3, 'Andrew', 'Contacted Maintainer'],
                            ['http://lala/dataset/yemen-admin-boundaries-never',
                             'Yemen - Administrative Boundaries Never',
                             'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Never',
                             '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                             'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492',
                             '2017-01-02T19:07:30.333492', 3, 'Andrew', 'Contacted Maintainer']
                            ]
                    ...
                    if TestWorksheet.sheetname == 'Maintainer':
                        return [['URL', 'Title', 'Organisation', 'Maintainer', 'Maintainer Email', 'Org Admins',
                                ...
                                ['http://lala/dataset/ourairports-myt', 'Airports in Mayotte', 'OurAirports',
                                 ...
                                 '2015-11-24T23:32:32.025059', '2017-01-01T19:07:30.333492',
                                 '2017-01-01T19:07:30.333492', 3, 'Aaron', 'Done']]
                    else:
                        return [['URL', 'Title', 'Error', 'Date Added', 'Date Last Occurred', 'No. Times', 'Assigned',
                                 'Status'],
        ...
        with Database(**database_broken) as session:
            ...
            assert TestDataFreshnessStatus.cells_result == [
                ...
                ['http://lala/dataset/yemen-admin-boundaries', 'Yemen - Administrative Boundaries', 'OCHA Yemen', '',
                 ...
                 '2017-01-02T19:07:30.333492', '2017-02-03T19:07:30.333492', 4, 'Andrew', 'Contacted Maintainer'],
                ['http://lala/dataset/projected-ipc-population-estimates-february-june-2016',
                 ...
                 '2016-07-17T10:13:34.099517', 'Delinquent', 'ClientConnectorError',
                 ...
                 '2017-02-03T19:07:30.333492', '2017-02-03T19:07:30.333492', 1, 'Peter', ''],
                ['http://lala/dataset/tendencias-humanitarias-y-paz-dic-2015',
                 ...
                 '2016-07-17T10:25:57.626518', 'Delinquent', 'ClientResponseError',
                ...
                ['http://lala/dataset/ourairports-som', 'Airports in Somewhere', 'OurAirports', '', '',
                 ...
                 '2015-11-24T23:36:47.280228', 'Overdue', 'Format Mismatch',
                ...
                ['http://lala/dataset/ourairports-rom', 'Airports in Romania', 'OurAirports', '', '',
                 ...
                 'List of airports in Romania:Fail', '2017-02-03T19:07:30.333492', '2017-02-03T19:07:30.333492', 1,
                 'Peter', ''],
            ...
            assert TestDataFreshnessStatus.email_users_result == \
                   [(['alex@lala.org', 'jenny@lala.org'], 'Broken datasets (03/02/2017)',
            ...
            assert TestDataFreshnessStatus.cells_result == [
                ...
                ['http://lala/dataset/projected-ipc-population-estimates-february-june-2016',
                 ...
                 '2016-07-17T10:13:34.099517', 'Delinquent', 'ClientConnectorError',
                 'Rural-Urban-and-IDP-Projected-Population-February-June-2016[1].xlsx:error: code= message=Cannot connect to host xxx ssl:False [Connection refused] raised=aiohttp.client_exceptions.ClientConnectorError url=xxx',
                 '2017-02-03T19:07:30.333492', '2017-02-03T19:07:30.333492', 1, 'John', ''],
                ['http://lala/dataset/yemen-admin-boundaries', 'Yemen - Administrative Boundaries', 'OCHA Yemen', '',
                 '',
                 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every year', '2015-12-28T06:39:20.134647',
                 'Delinquent', 'Server Error (may be temporary)', 'Admin-0.zip:Fail\nAdmin-3.zip:Fail',
            ...
            result = [
                ...
                ['http://lala/dataset/yemen-admin-boundaries', 'Yemen - Administrative Boundaries', 'OCHA Yemen', '',
                 '',
                 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every year', '2015-12-28T06:39:20.134647',
                 'Delinquent', 'Server Error (may be temporary)',
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-02-03T19:07:30.333492', '2017-02-03T19:07:30.333492', 1,
                 'Peter', ''],
                ['http://lala/dataset/tendencias-humanitarias-y-paz-dic-2015',
                 'Tendencias Humanitarias y Paz - Nov 2012 - Dic 2015', 'OCHA Colombia', 'blahdisp', 'blah@blah.com',
                 'blah3disp,blah5full', 'blah3@blah.com,blah5@blah.com', 'Every six months',
                ...
                ['http://lala/dataset/ourairports-wsm', 'Airports in Samoa', 'OurAirports', '', '',
                 ...
                 'List of airports in Samoa (HXL tags):Fail\nList of airports in Samoa (no HXL tags):Fail',
                 '2017-02-03T19:07:30.333492', '2017-02-03T19:07:30.333492', 1, 'Peter', ''],
                ['http://lala/dataset/yemen-admin-boundaries-never', 'Yemen - Administrative Boundaries Never',
                 'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Never',
                 '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492', '2017-01-02T19:07:30.333492', 3,
                 'Andrew', 'Contacted Maintainer'],
                ['http://lala/dataset/yemen-admin-boundaries-as-needed', 'Yemen - Administrative Boundaries Needed',
                 'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'As needed',
                 '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492', '2017-01-02T19:07:30.333492', 3,
                 'Andrew', 'Contacted Maintainer'],
                ['http://lala/dataset/yemen-admin-boundaries-month', 'Yemen - Administrative Boundaries Month',
                 'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every month',
                 '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492', '2017-01-02T19:07:30.333492', 3,
                 'Andrew', 'Contacted Maintainer'],
                ['http://lala/dataset/yemen-admin-boundaries-week', 'Yemen - Administrative Boundaries Week',
                 'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every week',
                 '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492', '2017-01-02T19:07:30.333492', 3,
                 'Andrew', 'Contacted Maintainer'],
                ['http://lala/dataset/yemen-admin-boundaries-day', 'Yemen - Administrative Boundaries Day',
                 ...
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492', '2017-01-02T19:07:30.333492', 3,
                 'Andrew', 'Contacted Maintainer'],
                ['http://lala/dataset/yemen-admin-boundaries-live', 'Yemen - Administrative Boundaries Live',
                 'OCHA Yemen', '', '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Live',
                 '2015-12-28T06:39:20.134647', 'Delinquent', 'Server Error (may be temporary)',
                 'Admin-0.zip:Fail\nAdmin-3.zip:Fail', '2017-01-02T19:07:30.333492', '2017-01-02T19:07:30.333492', 3,
                 'Andrew', 'Contacted Maintainer']]
            ...
            sheet.row_limit = 10
            freshness.process_broken()
            assert TestDataFreshnessStatus.cells_result == result[:11]
    ...
    def test_freshnessstatus(self, configuration, database_status, users, organizations):
        ...
        with Database(**database_status) as session:
            ...
            assert TestDataFreshnessStatus.email_users_result == [(['sharon@lala.org'],
                                                                   'WARNING: Fall in datasets on HDX today! (02/02/2017)',
                                                                   'Dear Sharon,\n\nThere are 1 (16%) fewer datasets today than yesterday on HDX which may indicate a serious problem so should be investigated!\n\nBest wishes,\nHDX Team',
                                                                   '<html>\n  <head></head>\n  <body>\n    <span>Dear Sharon,<br><br>There are 1 (16%) fewer datasets today than yesterday on HDX which may indicate a serious problem so should be investigated!<br><br>Best wishes,<br>HDX Team\n      <br/><br/>\n      <small>\n        <p>\n          <a href="http://data.humdata.org ">Humanitarian Data Exchange</a>\n        </p>\n        <p>\n          <a href="http://humdata.us14.list-manage.com/subscribe?u=ea3f905d50ea939780139789d&id=d996922315 ">            Sign up for our newsletter</a> |             <a href=" https://twitter.com/humdata ">Follow us on Twitter</a>             | <a href="mailto:hdx@un.org ">Contact us</a>\n        </p>\n      </small>\n    </span>\n  </body>\n</html>\n',
                                                                   ['blah2@blah.com', 'blah4@blah.com'], None)]

            TestDataFreshnessStatus.email_users_result = list()
            TestDataFreshnessStatus.cells_result = None
            freshness.process_delinquent()
            assert TestDataFreshnessStatus.email_users_result == \
                   [(['sharon@lala.org'], 'Delinquent datasets (02/02/2017)',
            ...
            assert TestDataFreshnessStatus.cells_result == [
                ['URL', 'Title', 'Organisation', 'Maintainer', 'Maintainer Email', 'Org Admins', 'Org Admin Emails',
                 'Update Frequency', 'Latest of Modifieds', 'Date Added', 'Date Last Occurred', 'No. Times', 'Assigned',
                 'Status'],
                ['http://lala/dataset/ourairports-myt', 'Airports in Mayotte', 'OurAirports', 'blah5full',
                 'blah5@blah.com', 'blah3disp,blah4disp,blah5full', 'blah3@blah.com,blah4@blah.com,blah5@blah.com',
                 'Every year', '2015-11-24T23:32:32.025059', '2017-01-01T19:07:30.333492',
                 '2017-02-02T19:07:30.333492', 3, 'Peter', 'Done'],
                ['http://lala/dataset/ourairports-wsm', 'Airports in Samoa', 'OurAirports', '', '',
                 'blah3disp,blah4disp,blah5full', 'blah3@blah.com,blah4@blah.com,blah5@blah.com', 'Every year',
                 '2015-11-24T23:32:30.661408', '2017-02-02T19:07:30.333492', '2017-02-02T19:07:30.333492',
                 1, 'Sharon', '']]

            expected_result = \
                [(['blah@blah.com'], 'Time to update your datasets on HDX (02/02/2017)',
                  ...
                  None, None),
                 (['blah4@blah.com'], 'Time to update your datasets on HDX (02/02/2017)',
                  ...
                  None, None),
                 (['blah5@blah.com'], 'Time to update your datasets on HDX (02/02/2017)',
                  'Dear blah5full,\n\nThe dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your dashboard on HDX.\n\nYemen - Administrative Boundaries (http://lala/dataset/yemen-admin-boundaries) with expected update frequency: Every year\n\nTip: You can decrease the "Expected Update Frequency" by clicking "Edit" on the top right of the dataset.\n\nBest wishes,\nHDX Team',
                  '<html>\n  <head></head>\n  <body>\n    <span>Dear blah5full,<br><br>The dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your <a href="https://data.humdata.org/dashboard/datasets">dashboard</a> on HDX.<br><br><a href="http://lala/dataset/yemen-admin-boundaries">Yemen - Administrative Boundaries</a> with expected update frequency: Every year<br><br>Tip: You can decrease the "Expected Update Frequency" by clicking "Edit" on the top right of the dataset.<br><br>Best wishes,<br>HDX Team\n      <br/><br/>\n      <small>\n        <p>\n          <a href="http://data.humdata.org ">Humanitarian Data Exchange</a>\n        </p>\n        <p>\n          <a href="http://humdata.us14.list-manage.com/subscribe?u=ea3f905d50ea939780139789d&id=d996922315 ">            Sign up for our newsletter</a> |             <a href=" https://twitter.com/humdata ">Follow us on Twitter</a>             | <a href="mailto:hdx@un.org ">Contact us</a>\n        </p>\n      </small>\n    </span>\n  </body>\n</html>\n',
                  None, None),
                 (['sharon@lala.org'], 'All overdue dataset emails (02/02/2017)',
            ...
            expected_result[3] = (
                ['elizabeth@lala.org'], restuple[1], restuple[2].replace('Sharon', 'system administrator'),
            ...
            restuple = expected_result[3]
            expected_result[3] = (
                ['blah2@blah.com', 'blah4@blah.com'], restuple[1], restuple[2], restuple[3], None, restuple[5])
            assert TestDataFreshnessStatus.email_users_result == expected_result
            TestDataFreshnessStatus.email_users_result = list()
            sheet.dutyofficer = {'name': 'Paul', 'email': 'paul@lala.org'}
            freshness.process_overdue(recipients='lizzy@lala.org')
            assert TestDataFreshnessStatus.email_users_result == \
                   [(['lizzy@lala.org'], 'Time to update your datasets on HDX (02/02/2017)',
                     'Dear blahdisp,\n\nThe dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your dashboard on HDX.\n\nTendencias Humanitarias y Paz - Nov 2012 - Dic 2015 (http://lala/dataset/tendencias-humanitarias-y-paz-dic-2015) with expected update frequency: Every six months\nProjected IPC population Estimates February - June 2016 (http://lala/dataset/projected-ipc-population-estimates-february-june-2016) with expected update frequency: Every six months\n\nTip: You can decrease the "Expected Update Frequency" by clicking "Edit" on the top right of the dataset.\n\nBest wishes,\nHDX Team',
                     '<html>\n  <head></head>\n  <body>\n    <span>Dear blahdisp,<br><br>The dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your <a href="https://data.humdata.org/dashboard/datasets">dashboard</a> on HDX.<br><br><a href="http://lala/dataset/tendencias-humanitarias-y-paz-dic-2015">Tendencias Humanitarias y Paz - Nov 2012 - Dic 2015</a> with expected update frequency: Every six months<br><a href="http://lala/dataset/projected-ipc-population-estimates-february-june-2016">Projected IPC population Estimates February - June 2016</a> with expected update frequency: Every six months<br><br>Tip: You can decrease the "Expected Update Frequency" by clicking "Edit" on the top right of the dataset.<br><br>Best wishes,<br>HDX Team\n      <br/><br/>\n      <small>\n        <p>\n          <a href="http://data.humdata.org ">Humanitarian Data Exchange</a>\n        </p>\n        <p>\n          <a href="http://humdata.us14.list-manage.com/subscribe?u=ea3f905d50ea939780139789d&id=d996922315 ">            Sign up for our newsletter</a> |             <a href=" https://twitter.com/humdata ">Follow us on Twitter</a>             | <a href="mailto:hdx@un.org ">Contact us</a>\n        </p>\n      </small>\n    </span>\n  </body>\n</html>\n',
                     None, None),
                    (['lizzy@lala.org'], 'Time to update your datasets on HDX (02/02/2017)',
                    ...
                    (['lizzy@lala.org'], 'Time to update your datasets on HDX (02/02/2017)',
                     ...
                     '<html>\n  <head></head>\n  <body>\n    <span>Dear blah5full,<br><br>The dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your <a href="https://data.humdata.org/dashboard/datasets">dashboard</a> on HDX.<br><br><a href="http://lala/dataset/yemen-admin-boundaries">Yemen - Administrative Boundaries</a> with expected update frequency: Every year<br><br>Tip: You can decrease the "Expected Update Frequency" by clicking "Edit" on the top right of the dataset.<br><br>Best wishes,<br>HDX Team\n      <br/><br/>\n      <small>\n        <p>\n          <a href="http://data.humdata.org ">Humanitarian Data Exchange</a>\n        </p>\n        <p>\n          <a href="http://humdata.us14.list-manage.com/subscribe?u=ea3f905d50ea939780139789d&id=d996922315 ">            Sign up for our newsletter</a> |             <a href=" https://twitter.com/humdata ">Follow us on Twitter</a>             | <a href="mailto:hdx@un.org ">Contact us</a>\n        </p>\n      </small>\n    </span>\n  </body>\n</html>\n',
                     None, None),
                    (['paul@lala.org'], 'All overdue dataset emails (02/02/2017)',
                     'Dear Paul,\n\nBelow are the emails which have been sent today to maintainers whose datasets are overdue. You may wish to follow up with them.\n\nDear blahdisp,\n\nThe dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your dashboard on HDX.\n\nTendencias Humanitarias y Paz - Nov 2012 - Dic 2015 (http://lala/dataset/tendencias-humanitarias-y-paz-dic-2015) with expected update frequency: Every six months\nProjected IPC population Estimates February - June 2016 (http://lala/dataset/projected-ipc-population-estimates-february-june-2016) with expected update frequency: Every six months\nDear blah4disp,\n\nThe dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your dashboard on HDX.\n\nYemen - Administrative Boundaries (http://lala/dataset/yemen-admin-boundaries) with expected update frequency: Every year\nDear blah5full,\n\nThe dataset(s) listed below are due for an update on the Humanitarian Data Exchange (HDX). You can update all of these in your dashboard on HDX.\n\nYemen - Administrative Boundaries (http://lala/dataset/yemen-admin-boundaries) with expected update frequency: Every year\n\nBest wishes,\nHDX Team',
    ...
    def test_freshnessmaintainerorgadmins(self, configuration, database_maintainer, users, organizations):
        ...
        with Database(**database_maintainer) as session:
            ...
            assert TestDataFreshnessStatus.email_users_result == \
                   [(['aaron@lala.org'], 'Datasets with invalid maintainer (02/02/2017)',
                     ...
                     ['blah2@blah.com', 'blah4@blah.com'], None),
                    (['aaron@lala.org'], 'Organizations with invalid admins (02/02/2017)',
            ...
            assert TestDataFreshnessStatus.cells_result == [[
                ...
                ['http://lala/dataset/tendencias-humanitarias-y-paz-dic-2015',
                 'Tendencias Humanitarias y Paz - Nov 2012 - Dic 2015', 'OCHA Colombia', 'blahdisp', 'blah@blah.com',
                 'blah3disp,blah5full', 'blah3@blah.com,blah5@blah.com', 'Every six months',
                 '2016-07-17T10:25:57.626518', '2017-02-02T19:07:30.333492', '2017-02-02T19:07:30.333492', 1, 'Aaron',
                 ''],
                ['http://lala/dataset/projected-ipc-population-estimates-february-june-2016',
                 'Projected IPC population Estimates February - June 2016', 'OCHA Somalia', 'blahdisp', 'blah@blah.com',
                 'blah3disp,blah4disp', 'blah3@blah.com,blah4@blah.com', 'Every six months',
                 '2016-07-17T10:13:34.099517', '2017-02-02T19:07:30.333492', '2017-02-02T19:07:30.333492', 1, 'Aaron',
                 ''],
                ['http://lala/dataset/yemen-admin-boundaries', 'Yemen - Administrative Boundaries', 'OCHA Yemen', '',
                 '', 'blah4disp,blah5full', 'blah4@blah.com,blah5@blah.com', 'Every year', '2015-12-28T06:39:20.134647',
                 '2017-02-02T19:07:30.333492', '2017-02-02T19:07:30.333492', 1, 'Aaron', ''],
                ['http://lala/dataset/ourairports-wsm', 'Airports in Samoa', 'OurAirports', '', '',
                 'blah3disp,blah4disp,blah5full', 'blah3@blah.com,blah4@blah.com,blah5@blah.com', 'Every year',
                 '2015-11-24T23:32:30.661408', '2017-02-02T19:07:30.333492', '2017-02-02T19:07:30.333492', 1, 'Aaron',
                 ''],
                ['http://lala/dataset/ourairports-myt', 'Airports in Mayotte', 'OurAirports', 'blah5full',
                 'blah5@blah.com', 'blah3disp,blah4disp,blah5full', 'blah3@blah.com,blah4@blah.com,blah5@blah.com',
                 'Every year', '2015-11-24T23:32:32.025059', '2017-01-01T19:07:30.333492', '2017-01-01T19:07:30.333492',
                 3, 'Aaron', 'Done']],
                [['URL', 'Title', 'Error', 'Date Added', 'Date Last Occurred', 'No. Times', 'Assigned', 'Status'],
                 ['http://lala/organization/ocha-somalia', 'OCHA Somalia', 'All org admins are sysadmins!',
                  '2017-01-01T19:07:30.333492', '2017-02-02T19:07:30.333492', 6, 'Aaron', '']]]
    ...
    def test_freshnessfailure(self, configuration, database_failure, users, organizations):
        ...
        now = parser.parse('2017-02-03 19:07:30.333492')
        sheet = Sheet(now)
        email = Email(now, send_emails=self.email_users, configuration=configuration)
    ...
    def test_freshnessdatasetsnoresources(self, configuration, database_noresources, users, organizations):
        ...
        with Database(**database_noresources) as session:
            ...
            assert TestDataFreshnessStatus.email_users_result == \
                   [(['andrew@lala.org'], 'Datasets with no resources (03/02/2017)',
            ...
            assert TestDataFreshnessStatus.cells_result == [
                ...
                ['http://lala/dataset/ourairports-wsm', 'Airports in Samoa',
                 ...
                 'blah3@blah.com,blah4@blah.com,blah5@blah.com', 'Every year',
                 '2015-11-24T23:32:30.661408', '2017-02-03T19:07:30.333492', '2017-02-03T19:07:30.333492',
                 1, 'Andrew', ''],
    ...
    def test_datasets_datagrid(self, configuration, database_datasets_modified_yesterday, users, organizations):
        ...
        with Database(**database_datasets_modified_yesterday) as session:
            ...
            expected_result = \
                [(['nafi@abc.org'], 'Candidates for the datagrid (02/02/2017)',
            ...
            expected_cells_result = \
                [['URL', 'Title', 'Organisation', 'Maintainer', 'Maintainer Email', 'Org Admins', 'Org Admin Emails',
                  'Dataset Date', 'Update Frequency', 'Latest of Modifieds', 'Date Added', 'Date Last Occurred',
                  'No. Times', 'Assigned',
                  'Status'],
                 ['http://lala/dataset/ourairports-wsm', 'Airports in Samoa', 'OurAirports', '', '',
                  'blah3disp,blah4disp,blah5full',
                  'blah3@blah.com,blah4@blah.com,blah5@blah.com', '', 'Every year', '2017-02-02T10:07:30.333492',
                  '2017-02-02T19:07:30.333492', '2017-02-02T19:07:30.333492', 1, 'Nafi', '']]
            assert TestDataFreshnessStatus.email_users_result == expected_result
            assert TestDataFreshnessStatus.cells_result == expected_cells_result
            TestDataFreshnessStatus.email_users_result = list()
            TestDataFreshnessStatus.cells_result = None
