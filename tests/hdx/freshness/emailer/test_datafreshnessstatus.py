...
class TestDataFreshnessStatus:
    ...
    def test_freshnessbroken(self, configuration, database_broken, users):
        ...
        assert TestDataFreshnessStatus.email_users_result == \
               [([{'fullname': 'blahfull', 'email': 'blah@blah.com', 'name': 'blahname', 'sysadmin': False,
                   'display_name': 'blahdisp', 'id': 'blah'},
                  {'fullname': 'blah5full', 'email': 'blah5@blah.com', 'name': 'blah5name', 'sysadmin': False,
                   'id': 'blah5'}], 'Broken datasets',
                 'Dear system administrator,\n\nThe following datasets have broken resources:\n\nOCHA Somalia\nProjected IPC population Estimates February - June 2016 (http://lala/dataset/projected-ipc-population-estimates-february-june-2016) maintained by blahdisp (blah@blah.com) with expected update frequency: every six months and freshness: Delinquent\n    Resource Rural-Urban-and-IDP-Projected-Population-February-June-2016[1].xlsx (93a361c6-ace7-4cea-8407-ffd2c30d0853) has error: Fail!\nOCHA Yemen\nYemen - Administrative Boundaries (http://lala/dataset/yemen-admin-boundaries) with missing maintainer and organization administrators blah4disp (blah4@blah.com), blah5full (blah5@blah.com) with expected update frequency: every year and freshness: Delinquent\n    Resource Admin-0.zip (2ade2886-2990-41d0-a89b-33c5d1de6e3a) has error: Fail!\n    Resource Admin-1.zip (69146e1e-62c7-4e7f-8f6c-2dacffe02283) has error: Fail!\n    Admin-2.zip (f60035dc-624a-49cf-95de-9d489c07d3b9)    Admin-3.zip (f60035dc-624a-49cf-95de-9d489c07d3ba)\nOurAirports\nAirports in Mayotte (http://lala/dataset/ourairports-myt) maintained by blah5full (blah5@blah.com) with expected update frequency: every year and freshness: Delinquent\n    Resource List of airports in Mayotte (HXL tags) (89a99c0a-4cbf-4717-9cde-987042bc435f) has error: Fail!\n    Resource List of airports in Mayotte (no HXL tags) (a5797320-ce50-4b3a-99a5-76aabd0633d9) has error: Fail!\nAirports in Romania (http://lala/dataset/ourairports-rom) with missing maintainer and organization administrators blah3disp (blah3@blah.com), blah4disp (blah4@blah.com), blah5full (blah5@blah.com) with expected update frequency: every year and freshness: Overdue\n    Resource List of airports in Romania (89b35e5b-32ea-4470-a854-95e47fe1a958) has error: Fail!\nAirports in Samoa (http://lala/dataset/ourairports-wsm)\n\nBest wishes,\nHDX Team',
                 '<html>\n  <head></head>\n  <body>\n    <span>Dear system administrator,<br><br>The following datasets have broken resources:<br><br><b>OCHA Somalia</b><br><a href="http://lala/dataset/projected-ipc-population-estimates-february-june-2016">Projected IPC population Estimates February - June 2016</a> maintained by <a href="mailto:blah@blah.com">blahdisp</a> with expected update frequency: every six months and freshness: Delinquent<br>&nbsp&nbsp&nbsp&nbspResource Rural-Urban-and-IDP-Projected-Population-February-June-2016[1].xlsx (93a361c6-ace7-4cea-8407-ffd2c30d0853) has error: Fail!<br><b>OCHA Yemen</b><br><a href="http://lala/dataset/yemen-admin-boundaries">Yemen - Administrative Boundaries</a> with missing maintainer and organization administrators <a href="mailto:blah4@blah.com">blah4disp</a>, <a href="mailto:blah5@blah.com">blah5full</a> with expected update frequency: every year and freshness: Delinquent<br>&nbsp&nbsp&nbsp&nbspResource Admin-0.zip (2ade2886-2990-41d0-a89b-33c5d1de6e3a) has error: Fail!<br>&nbsp&nbsp&nbsp&nbspResource Admin-1.zip (69146e1e-62c7-4e7f-8f6c-2dacffe02283) has error: Fail!<br>&nbsp&nbsp&nbsp&nbspAdmin-2.zip (f60035dc-624a-49cf-95de-9d489c07d3b9)&nbsp&nbsp&nbsp&nbspAdmin-3.zip (f60035dc-624a-49cf-95de-9d489c07d3ba)<br><b>OurAirports</b><br><a href="http://lala/dataset/ourairports-myt">Airports in Mayotte</a> maintained by <a href="mailto:blah5@blah.com">blah5full</a> with expected update frequency: every year and freshness: Delinquent<br>&nbsp&nbsp&nbsp&nbspResource List of airports in Mayotte (HXL tags) (89a99c0a-4cbf-4717-9cde-987042bc435f) has error: Fail!<br>&nbsp&nbsp&nbsp&nbspResource List of airports in Mayotte (no HXL tags) (a5797320-ce50-4b3a-99a5-76aabd0633d9) has error: Fail!<br><a href="http://lala/dataset/ourairports-rom">Airports in Romania</a> with missing maintainer and organization administrators <a href="mailto:blah3@blah.com">blah3disp</a>, <a href="mailto:blah4@blah.com">blah4disp</a>, <a href="mailto:blah5@blah.com">blah5full</a> with expected update frequency: every year and freshness: Overdue<br>&nbsp&nbsp&nbsp&nbspResource List of airports in Romania (89b35e5b-32ea-4470-a854-95e47fe1a958) has error: Fail!<br><a href="http://lala/dataset/ourairports-wsm">Airports in Samoa</a><br><br>Best wishes,<br>HDX Team\n      <br/><br/>\n      <small>\n        <p>\n          <a href="http://data.humdata.org ">Humanitarian Data Exchange</a>\n        </p>\n        <p>\n          <a href="http://humdata.us14.list-manage.com/subscribe?u=ea3f905d50ea939780139789d&id=d996922315 ">            Sign up for our newsletter</a> |             <a href=" https://twitter.com/humdata ">Follow us on Twitter</a>             | <a href="mailto:hdx@un.org ">Contact us</a>\n        </p>\n      </small>\n    </span>\n  </body>\n</html>\n')]
        freshness.close()
